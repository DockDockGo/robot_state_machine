...
class StateMachineActionServer(Node):
    ...
    def execute_callback(self, goal_handle):
        ...
        undock_package = (goal_handle.request.start_dock_id, 'undock', goal_handle.request.start_dock_id)
        dock_package = (goal_handle.request.end_dock_id, 'dock', goal_handle.request.end_dock_id)
        output_feedback_msg = StateMachine.Feedback()
